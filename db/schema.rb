...
ActiveRecord::Schema.define(version: 2020_07_15_023650) do
  ...
  create_table "interactive_books", force: :cascade do |t|
    t.integer "book_id", null: false
    t.integer "user_id", null: false
    t.integer "action"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["book_id"], name: "index_interactive_books_on_book_id"
    t.index ["user_id"], name: "index_interactive_books_on_user_id"
  end
  ...
  create_table "request_borrow_books", force: :cascade do |t|
    t.integer "book_id", null: false
    t.integer "user_id", null: false
    t.date "start_date"
    t.date "end_date"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["book_id"], name: "index_request_borrow_books_on_book_id"
    t.index ["user_id"], name: "index_request_borrow_books_on_user_id"
  end
